# Preserve click IDs: implementation notes

This reference retains the detailed implementation notes from the original
skill. Use only the relevant sections after the root router selects a boundary.
